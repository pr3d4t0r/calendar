...
define("PROJECT_SQLITE_FILE", "/var/www/calendar_server/Specific/db/db.sqlite");
...
define("BAIKAL_ENCRYPTION_KEY", '03e9a9ee7f6e3d0050b9d4c75acfd1d8');

# The currently configured Baïkal version
define("BAIKAL_CONFIGURED_VERSION", '0.4.5');
